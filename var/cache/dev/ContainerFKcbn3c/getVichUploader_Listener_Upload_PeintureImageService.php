...
<<<<<<<< HEAD:var/cache/dev/ContainerWVIyxju/getVichUploader_Listener_Upload_PeintureImageService.php
namespace ContainerWVIyxju;

========
namespace ContainerFKcbn3c;
>>>>>>>> 1a5dbf8f9b9a69f8f9fc8a66fd20c63d634debaf:var/cache/dev/ContainerFKcbn3c/getVichUploader_Listener_Upload_PeintureImageService.php
 ...
 */
class getVichUploader_Listener_Upload_PeintureImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.peinture_image' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.peinture_image'])) {
            return $container->privates['vich_uploader.listener.upload.peinture_image'];
        }

        return $container->privates['vich_uploader.listener.upload.peinture_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('peinture_image', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
