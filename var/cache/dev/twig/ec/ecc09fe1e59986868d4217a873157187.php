...
class __TwigTemplate_308d2260098f600186c6a898034fa630 extends Template
{
    ...
    <div class=\"card shadow-lg border-0\" style=\"width: 100%; max-width: 600px; background-color: #e6f4ea; border-radius: 10px; padding: 30px; font-size: 1.1rem;\">
        ...
        yield "\" required autofocus class=\"form-control custom-input\">
            ...
            <div class=\"d-grid\">
                <button type=\"submit\" class=\"btn btn-success btn-lg\" style=\"border-radius: 8px; font-size: 1.1rem;\">
                    Se connecter
                </button>
            </div>
